...
public class test1 {
  public static void main(String[] arguments) {
    ...
    //Ask user for search grade, keep asking until valid input
    int search_grade = -1;
    ...
    //Ask for another grade to search, and loop again until there is a valid input
    search_grade = -1;
    ...
    PrintOutArray(rnd_arrGrades, "Sorted again: ");
  }
  ...
  public static int AskForInputGrade(int i, int prior_input) {
		...
		if(sc.hasNextInt()){
			...
			System.out.print("Can you stop playing this is not a number... ");
			return input_val;
		}

		//Check if it is between 0-100
		if(input_val < 0 || input_val > 100) {
			System.out.print("It has to be between 0 and 100... ");
			return -1;
		}

		//Check if this input is greater or equal to the previous input
		if(input_val < prior_input) {
			System.out.print("The grade must be greater or equal to the previous grade, ");
			return -1;
		}
